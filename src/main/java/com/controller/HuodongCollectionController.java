    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(huodongCollection !=null){
            ...
            BeanUtils.copyProperties( huodongCollection , view );//把实体数据重构到view中
                ...
                //级联表
                ZhiyuanzheEntity zhiyuanzhe = zhiyuanzheService.selectById(huodongCollection.getZhiyuanzheId());
                if(zhiyuanzhe != null){
    ...
    */
    ...
    public R save(@RequestBody HuodongCollectionEntity huodongCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            huodongCollection.setZhiyuanzheId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<HuodongCollectionEntity> queryWrapper = new EntityWrapper<HuodongCollectionEntity>()
            ...
            .eq("zhiyuanzhe_id", huodongCollection.getZhiyuanzheId())
...
//                            huodongCollectionEntity.setZhiyuanzheId(Integer.valueOf(data.get(0)));   //志愿者 要改的
