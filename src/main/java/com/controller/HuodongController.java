    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(huodong !=null){
            ...
            BeanUtils.copyProperties( huodong , view );//把实体数据重构到view中
                ...
                //级联表
                HuodongchengbanfangEntity huodongchengbanfang = huodongchengbanfangService.selectById(huodong.getHuodongchengbanfangId());
    ...
    */
    ...
    public R save(@RequestBody HuodongEntity huodong, HttpServletRequest request){
        ...
        if(false)
            ...
            huodong.setHuodongchengbanfangId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<HuodongEntity> queryWrapper = new EntityWrapper<HuodongEntity>()
            .eq("huodongchengbanfang_id", huodong.getHuodongchengbanfangId())
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            HuodongEntity huodongEntity = new HuodongEntity();
//                            huodongEntity.setHuodongchengbanfangId(Integer.valueOf(data.get(0)));   //活动承办方 要改的
